...
import { Check, ArrowRight, Globe, Smartphone, Shield } from 'lucide-react'
    ...
    return (
        <>
            ...
            <main className="min-h-screen pt-32 pb-20 bg-slate-950">
                ...
                <section className="px-6 mb-24 text-center">
                    <div className="container mx-auto max-w-4xl">
                        <h1 className="font-display text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
                            Premium Services.<br /> Tailored Solutions.
                        </h1>
                        <p className="text-xl text-slate-400 max-w-2xl mx-auto">
                            Whether you need a simple landing page or a complex mobile app, we have the right solution to power your growth.
                        </p>
                    </div>
                </section>
                ...
                {/* Packages Grid (Without Prices) */}
                <section className="px-6 relative">
                    <div className="container mx-auto max-w-7xl">
                        <h2 className="text-3xl font-bold text-white text-center mb-4 font-display">Our Packages</h2>
                        <p className="text-slate-400 text-center mb-12 max-w-2xl mx-auto">
                            Choose a package that fits your needs. We'll provide a custom quote based on your specific requirements.
                        </p>

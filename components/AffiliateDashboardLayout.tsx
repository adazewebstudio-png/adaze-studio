...
import { LayoutDashboard, Users, DollarSign, Gift, LogOut, Menu, X, TrendingUp } from 'lucide-react'
...
export default function AffiliateDashboardLayout({ children }: DashboardLayoutProps) {
    ...
    return (
        <div className="min-h-screen bg-slate-950 flex">
            ...
            {/* Sidebar */}
            <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-72 bg-slate-900 border-r border-white/10 transform transition-transform lg:transform-none ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
                <div className="flex flex-col h-full">
                    ...
                    {/* User Info */}
                    {affiliate && (
                        <div className="p-4 mx-4 mt-4 rounded-xl bg-slate-800/50 border border-white/5">
                    ...
                    {/* Stats Summary */}
                    {affiliate && (
                        <div className="p-4 mx-4 mb-4 rounded-xl bg-gradient-to-br from-emerald-900/30 to-slate-900 border border-emerald-500/20">
